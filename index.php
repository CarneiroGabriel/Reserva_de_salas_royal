                  ...
                  <?php if ($userInfo["tipo"] == "adm") { ?>
                    <div class="panel-heading">
                      ...
                      <div class="right">
                        ...
                        <button type="button" class=""><i class="lnr lnr-pencil" data-toggle="modal" data-target="#exampleModal3" data-whateverid3="<?php echo $row_salas['id']; ?>" data-whatever3="<?php echo $row_salas['titulo']; ?>" data-whateverdescricao3="<?php echo $descricao_sala; ?>" data-whateverlocalizacao3="<?php echo $localizacao_sala; ?>" data-whateverlugares3="<?php echo $lugares_sala; ?>" data-whatevertelefone3="<?php echo $telefone_sala; ?>" data-whateverskype3="<?php echo $skype_sala; ?>" data-whateverteams3="<?php echo $teams_sala; ?>"></i></button>

                        <button type="button" style="cursor: pointer;" class="" data-toggle="modal" data-target="#exampleModal2" data-whatever2="<?php echo $row_salas['titulo']; ?>"><i class="lnr lnr-trash"></i></button>
                      </div>
                    </div>
                  <?php } ?>
                    ...
                    <div style="cursor:pointer;" class="panel-body no-padding bg-primary text-center" onClick="document.getElementById('<?php echo $row_salas['valor']; ?>').submit();">
                      <div class="padding-top-30 padding-bottom-30" style="height:200px; background:url(<?php echo $row_salas['localizacao']?>) #a18959  ;background-size: 100% 100%;">
                        ...
                        <label>Capacidade: </label><span> <?php echo $row_salas['lugares']; ?></spam><br>
                          <label>Descrição: </label><span> <?php echo $row_salas['descricao']; ?></spam>
